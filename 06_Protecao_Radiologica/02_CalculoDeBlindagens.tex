...
\begin{document}
    ...
    \section{Limites e Definições Para o Cálculo de Blindagens}
        ...
        \subsubsection*{Limite de Dose (P)}
        ...
        \subsubsection*{Carga de Trabalho (W)}
        ...
        \subsubsection*{Fator Ocupação (T)}
    ...
    \section{Cálculos de Blindagem para as Barreiras}
        ...
        \subsubsection*{Largura do Cinturão Primário}
        ...
        \subsubsection*{Barreiras Lamidadas}
    ...
    \subsubsection*{Dose Equivalente Total na Porta do Labirinto}   
