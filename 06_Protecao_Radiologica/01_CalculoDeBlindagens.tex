    ...
    \section{Calculo de Blindagens}
        ...
        \subsection{Largura do Cinturão Primário}
            ...
            \begin{itemize}
                ...
                \item Na maior parte dos aceleradores, o maior tamanho de campo é de \qtyproduct{40 x 40}{cm} na distância Fonte-Superfície (SSD) de \qty{100}{cm}; Com o tamanho máximo da diagonal limitado a ~\qty{50}{cm} na SSD de \qty{100}{cm}. 
        ...
        \subsection{Portas e Labirintos}
            ...
            \begin{itemize}
                \item $H_S$ = Dose equivalente por semana devito ao espalhamento do feixe primário pelas superfícies da sala de tratamento;
                ...
                \item $H_{ps}$ = Dose equivalente por semana devido ao fixe primário espalhado pelo paciente;
                \item $H_{LT}$ = A Radiação de fuga que é transmitida diretamente atravé da parede interna do labirinto.
            \end{itemize}
