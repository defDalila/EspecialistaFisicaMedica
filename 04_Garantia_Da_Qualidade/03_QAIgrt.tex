...
\section{Sistemas de Imagens}
    ...
    \begin{itemize}[label=\textcolor{CarnationPink}{$\blacktriangleright$}]
        ...
        \item Imagens de RM em MR-\ce{^{60}Co} treatment unit (ViewRay Inc., Bedford, OH) e Aceleradores lineares acoplados a MR.
...
\section{Imagem Radiográfica: Qualidade da Imagem e Dose}
    ...
    \begin{figure}[h]
        ...
        \fcolorbox{DarkTurquoise}{white}{%
            \includegraphics[width=0.5\textwidth]{Imagens/artefatos.jpg}
        }%
...
\subsection*{QA Geométrico}
    ...
    \begin{wrapfigure}{r}{0.48\textwidth}
        \centering
        \fcolorbox{DarkTurquoise}{white}{%
            \includegraphics[width=0.4\textwidth]{Imagens/pentaguide.JPG}
        }%
...
\subsection*{QA da Qualidade da Imagem}
    ...
    \begin{figure}[h]
        ...
        \subfigure{
		\fcolorbox{DarkTurquoise}{white}{%
			\includegraphics[width=0.28\textwidth]{Imagens/lasVegasPhantom1.JPG}
		}}%
        \subfigure{
		\fcolorbox{DarkTurquoise}{white}{%
			\includegraphics[width=0.30\textwidth]{Imagens/lasVegasPhantom.jpg}
		}} %
    ...
    \begin{figure}[h]
        ...
        \subfigure{
		    \fcolorbox{DarkTurquoise}{white}{%
			\includegraphics[width=0.32\textwidth]{Imagens/qaImagemPlanar.JPG}
		}}%
        \subfigure{
		    \fcolorbox{DarkTurquoise}{white}{%
			\includegraphics[width=0.27\textwidth]{Imagens/mceclip0.png}
		}}%
    ...
    \begin{figure}[h]
        \centering
        \fcolorbox{DarkTurquoise}{white}{%
            \includegraphics[width=0.5\textwidth]{Imagens/torleeds.jpg}
        }%
