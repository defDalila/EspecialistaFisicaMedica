...
\section{Fator OFF-Axis e Perfis de Feixe}
    ...
    \begin{figure}[h]
        ...
        \fcolorbox{DarkTurquoise}{white}{%
            \includegraphics[width=0.5\textwidth]{Imagens/perfiDeFeixe.JPG}
        }%
