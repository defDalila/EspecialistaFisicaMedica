...
\begin{document}
	...
	As qualidades de feixes que são compatíveis para aplicação do protocolo TRS-398 são:
		...
		Para o TG-51 podem ser aplicados as qualidades de fótons com energia nominal variando entre o \ce{^{60}Co} (média de 1.25 MeV) e 50 MV e para qualidades de elétrons com energia nominal variando entre 4 MeV e 50 MeV. 
	...
	\begin{exemplo}[Fator de Calibração]
		\begin{itemize}
