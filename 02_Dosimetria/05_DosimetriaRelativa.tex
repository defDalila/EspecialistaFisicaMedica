...
\subsection*{Dosímetros 2D e 3D}
	...
	\begin{figure}[h]
		...
		\fcolorbox{DarkTurquoise}{white}{%
			\includegraphics[width=0.8\textwidth]{Imagens/dosimetrosDosimetriaRelativa.JPG}
		}%
...
\section{Prática Recomendada para Varredura do Feixe}
	...
	\begin{wrapfigure}{l}{0.45\textwidth}
		\centering
		\fcolorbox{DarkTurquoise}{white}{%
			\includegraphics[width=0.41\textwidth]{Imagens/scanningArmTilt.JPG}
		}%
...
\subsection*{Posicionamento do Detector de Referência}
	...
	\begin{wrapfigure}{r}{0.42\textwidth}
		\centering
		\fcolorbox{DarkTurquoise}{white}{%
			\includegraphics[width=0.35\textwidth]{Imagens/locaisDetectoresReferencia.JPG}
		}%
