...
\author{\LobsterTwo\Large{Tratamento com Fótons e Planejamento}\nocite{*}}
\date{\LobsterTwo\textit{Dalila Mendonça}}
\begin{document}
	\maketitle
    
\begin{exemplo}[Tratamentos com Fótons]
    \textcolor{MediumOrchid}{\LobsterTwo\textbf{Qualidade Do Feixe}}
    \begin{itemize}
    ...
    \textcolor{MediumOrchid}{\LobsterTwo\textbf{Fatores que Afetam a deposição de dose pelos fótons}}
    \begin{itemize}
        ...
        \item O aumento da PDP com o tamanho de campo é maior para feixes de baixa energia. Com altas energias, a maior parte do espalhamento ocorre na mesma direção do fóton incidente portanto o espalhamento lateral é menor.
    ...
    \textcolor{MediumOrchid}{\LobsterTwo\textbf{Cálculo de Unidades Monitoras}}
    \begin{itemize}
...
\begin{exemplo}[Básico de Planejamento de Tratamento]
    \begin{itemize}
